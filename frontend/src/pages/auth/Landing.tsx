...
import { ChevronDown, GraduationCap, BookOpen, Building2, ShieldCheck } from 'lucide-react';
          ...
          {isDropdownOpen && (
            <div className="absolute right-0 mt-2 w-72 bg-white/95 backdrop-blur-md rounded-xl border border-slate-200/80 shadow-lg py-2 origin-top-right transition-all duration-200 z-50 animate-in">
              ...
              >
                ...
                <div className="flex flex-col">
                  <span className="text-sm font-semibold">Institution Portal</span>
                  <span className="text-xs text-slate-500 mt-0.5">College & university management</span>
                </div>
              </Link>
