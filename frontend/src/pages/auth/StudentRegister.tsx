  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center flex flex-col items-center justify-center">
        ...
        <p className="mt-2 text-center text-sm text-slate-500 flex items-center justify-center gap-1.5">
          <Shield className="h-4 w-4 text-blue-600 inline shrink-0" />
          Register to access proctored assessments and results
        </p>
      </div>
